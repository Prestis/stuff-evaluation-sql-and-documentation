...
DROP TRIGGER IF EXISTS valueLimit1;
DELIMITER $
...
DROP TRIGGER IF EXISTS finalGrade;
DELIMITER $ 
...
DROP TRIGGER IF EXISTS finalGrade2;
DELIMITER $
...
//Ισως χρειαστει τριγκερ για να γίνεται αύξηση του num ξεχωριστα για κάθε employee
